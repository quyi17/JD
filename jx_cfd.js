/**
 *
 * upstream -> https://github.com/MoPoQAQ/Script/blob/main/Me/jx_cfd.js
 Name: 京喜财富岛
 Address: 京喜App ====>>>> 全民赚大钱
...
const tokenStr = process.env.JX_APP_TOKEN // 手动抓包，获取token
$.tokens = [];
...
!(async () => {
  ...
  for (let i = 0; i < $.cookieArr.length; i++) {
    ...
    $.currentToken = Object.fromEntries(new URLSearchParams(tokenStr))
    if ($.currentCookie) {
